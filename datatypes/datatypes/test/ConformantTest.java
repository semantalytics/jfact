...
public class ConformantTest extends TestCase {
	Datatype[] list = DatatypeFactory.getValues();

	public void testCompatibility() {
		for (int i = 0; i < list.length; i++) {
			assertTrue(list[i].equals(DatatypeFactory.LITERAL())
					|| list[i].getAncestors().contains(DatatypeFactory.LITERAL()));
		}
		...
		assertTrue(DatatypeFactory.DATETIMESTAMP().getAncestors()
				.contains(DatatypeFactory.DATETIME()));
		assertTrue(DatatypeFactory.DATETIMESTAMP().getAncestors().size() == 2);
		assertTrue(DatatypeFactory.DECIMAL().getAncestors()
				.contains(DatatypeFactory.REAL()));
		assertTrue(DatatypeFactory.DECIMAL().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.DECIMAL().getAncestors().size() == 3);
		assertTrue(DatatypeFactory.RATIONAL().getAncestors()
				.contains(DatatypeFactory.REAL()));
		...
		assertTrue(DatatypeFactory.BYTE().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.BYTE().getAncestors()
				.contains(DatatypeFactory.DECIMAL()));
		assertTrue(DatatypeFactory.BYTE().getAncestors()
				.contains(DatatypeFactory.INTEGER()));
		...
		assertTrue(DatatypeFactory.BYTE().getAncestors()
				.contains(DatatypeFactory.SHORT()));
		...
		assertTrue(DatatypeFactory.INT().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.INT().getAncestors()
				.contains(DatatypeFactory.DECIMAL()));
		assertTrue(DatatypeFactory.INT().getAncestors()
		...
		assertTrue(DatatypeFactory.INTEGER().getAncestors()
				.contains(DatatypeFactory.REAL()));
		assertTrue(DatatypeFactory.INTEGER().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.INTEGER().getAncestors()
		...
		assertTrue(DatatypeFactory.LONG().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.LONG().getAncestors()
				.contains(DatatypeFactory.DECIMAL()));
		assertTrue(DatatypeFactory.LONG().getAncestors()
		...
		assertTrue(DatatypeFactory.NEGATIVEINTEGER().getAncestors()
				.contains(DatatypeFactory.REAL()));
		assertTrue(DatatypeFactory.NEGATIVEINTEGER().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.NEGATIVEINTEGER().getAncestors()
		...
		assertTrue(DatatypeFactory.NEGATIVEINTEGER().getAncestors()
				.contains(DatatypeFactory.INTEGER()));
		assertTrue(DatatypeFactory.NEGATIVEINTEGER().getAncestors()
				.contains(DatatypeFactory.NONPOSITIVEINTEGER()));
		assertTrue(DatatypeFactory.NEGATIVEINTEGER().getAncestors().size() == 6);
		assertTrue(DatatypeFactory.NONNEGATIVEINTEGER().getAncestors()
				.contains(DatatypeFactory.REAL()));
		assertTrue(DatatypeFactory.NONNEGATIVEINTEGER().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.NONNEGATIVEINTEGER().getAncestors()
		...
		assertTrue(DatatypeFactory.NONPOSITIVEINTEGER().getAncestors()
				.contains(DatatypeFactory.REAL()));
		assertTrue(DatatypeFactory.NONPOSITIVEINTEGER().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.NONPOSITIVEINTEGER().getAncestors()
		...
		assertTrue(DatatypeFactory.POSITIVEINTEGER().getAncestors()
				.contains(DatatypeFactory.REAL()));
		assertTrue(DatatypeFactory.POSITIVEINTEGER().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.POSITIVEINTEGER().getAncestors()
		...
		assertTrue(DatatypeFactory.POSITIVEINTEGER().getAncestors()
				.contains(DatatypeFactory.INTEGER()));
		assertTrue(DatatypeFactory.POSITIVEINTEGER().getAncestors()
				.contains(DatatypeFactory.NONNEGATIVEINTEGER()));
		...
		assertTrue(DatatypeFactory.UNSIGNEDBYTE().getAncestors()
				.contains(DatatypeFactory.REAL()));
		assertTrue(DatatypeFactory.UNSIGNEDBYTE().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.UNSIGNEDBYTE().getAncestors()
		...
		assertTrue(DatatypeFactory.UNSIGNEDBYTE().getAncestors()
				.contains(DatatypeFactory.NONNEGATIVEINTEGER()));
		assertTrue(DatatypeFactory.UNSIGNEDBYTE().getAncestors()
				.contains(DatatypeFactory.UNSIGNEDLONG()));
		assertTrue(DatatypeFactory.UNSIGNEDBYTE().getAncestors()
				.contains(DatatypeFactory.UNSIGNEDINT()));
		assertTrue(DatatypeFactory.UNSIGNEDBYTE().getAncestors()
				.contains(DatatypeFactory.UNSIGNEDSHORT()));
		assertTrue(DatatypeFactory.UNSIGNEDBYTE().getAncestors().size() == 9);
		assertTrue(DatatypeFactory.UNSIGNEDINT().getAncestors()
				.contains(DatatypeFactory.REAL()));
		assertTrue(DatatypeFactory.UNSIGNEDINT().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.UNSIGNEDINT().getAncestors()
		...
		assertTrue(DatatypeFactory.UNSIGNEDLONG().getAncestors()
				.contains(DatatypeFactory.REAL()));
		assertTrue(DatatypeFactory.UNSIGNEDLONG().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.UNSIGNEDLONG().getAncestors()
		...
		assertTrue(DatatypeFactory.UNSIGNEDSHORT().getAncestors()
				.contains(DatatypeFactory.REAL()));
		assertTrue(DatatypeFactory.UNSIGNEDSHORT().getAncestors()
				.contains(DatatypeFactory.RATIONAL()));
		assertTrue(DatatypeFactory.UNSIGNEDSHORT().getAncestors()
		...
		assertTrue(DatatypeFactory.LANGUAGE().getAncestors()
				.contains(DatatypeFactory.NORMALIZEDSTRING()));
		assertTrue(DatatypeFactory.LANGUAGE().getAncestors()
				.contains(DatatypeFactory.TOKEN()));
		assertTrue(DatatypeFactory.LANGUAGE().getAncestors().size() == 4);
		assertTrue(DatatypeFactory.NAME().getAncestors()
				.contains(DatatypeFactory.STRING()));
		assertTrue(DatatypeFactory.NAME().getAncestors()
				.contains(DatatypeFactory.NORMALIZEDSTRING()));
		assertTrue(DatatypeFactory.NAME().getAncestors()
		...
		assertTrue(DatatypeFactory.NCNAME().getAncestors()
				.contains(DatatypeFactory.STRING()));
		assertTrue(DatatypeFactory.NCNAME().getAncestors()
				.contains(DatatypeFactory.NORMALIZEDSTRING()));
		assertTrue(DatatypeFactory.NCNAME().getAncestors()
		...
		assertTrue(DatatypeFactory.NMTOKENS().getAncestors()
				.contains(DatatypeFactory.TOKEN()));
		assertTrue(DatatypeFactory.NMTOKENS().getAncestors()
				.contains(DatatypeFactory.NMTOKEN()));
		assertTrue(DatatypeFactory.NMTOKENS().getAncestors().size() == 5);
		assertTrue(DatatypeFactory.NORMALIZEDSTRING().getAncestors()
				.contains(DatatypeFactory.STRING()));
		assertTrue(DatatypeFactory.NORMALIZEDSTRING().getAncestors().size() == 2);
		assertTrue(DatatypeFactory.TOKEN().getAncestors()
				.contains(DatatypeFactory.STRING()));
		assertTrue(DatatypeFactory.TOKEN().getAncestors()
				.contains(DatatypeFactory.NORMALIZEDSTRING()));
		assertTrue(DatatypeFactory.NORMALIZEDSTRING().getAncestors().size() == 2);
