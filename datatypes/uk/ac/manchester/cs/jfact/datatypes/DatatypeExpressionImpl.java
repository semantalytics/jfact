...
class DatatypeExpressionImpl<O extends Comparable<O>> extends ABSTRACT_DATATYPE<O>
	...
	public String toString() {
		...
		return getClass().getName()+"("+host.toString()+"(extra facets:"+knownFacetValues+"))";
	}
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof DatatypeExpression) {
			...
			return this.host.equals(datatypeExpression.getHostType()) && this.knownFacetValues.equals(datatypeExpression.getKnownFacetValues());
		}
