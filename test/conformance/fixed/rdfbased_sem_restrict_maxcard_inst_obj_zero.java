...
public class rdfbased_sem_restrict_maxcard_inst_obj_zero extends TestCase {
	public void testrdfbased_sem_restrict_maxcard_inst_obj_zero() {
		...
		String premise = "<rdf:RDF\n" + "    xmlns:rdf=\"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"\n" + "    xmlns:owl=\"http://www.w3.org/2002/07/owl#\"\n" + "    xmlns:xsd=\"http://www.w3.org/2001/XMLSchema#\"\n" + "    xmlns:ex=\"http://www.example.org#\"\n"
				...
				// added
				+ "<owl:Class rdf:about=\"http://www.example.org#z\"/>" + "<owl:ObjectProperty rdf:about=\"http://www.example.org#p\"/>"
				// end add
				...
				//added
				+ "<rdfs:subClassOf><rdf:Description>" + "<rdf:type rdf:resource=\"http://www.w3.org/2002/07/owl#Restriction\"/>"
				// end add
