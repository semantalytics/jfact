...
public final class ConceptObjectExactCardinality implements ConceptObjectCardinalityExpression, NumberArg {
	private final ConceptExpression delegate;
	private final int N;
	private final ObjectRoleExpression roleDelegate;

	public ConceptObjectExactCardinality(int n, final ObjectRoleExpression R, final ConceptExpression C) {
		N = n;
		delegate = C;
		roleDelegate = R;
	}
