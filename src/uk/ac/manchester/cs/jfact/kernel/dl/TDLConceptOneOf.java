...
public class TDLConceptOneOf extends TDLNAryExpressionImpl<TDLIndividualName> implements TDLNAryExpression<TDLIndividualName>, TDLConceptExpression {
	/** create one-of from individuals in the given array */
	public TDLConceptOneOf(final List<TDLExpression> v) {
		add(v);
	}
