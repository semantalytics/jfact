...
public class TDLAxiomEquivalentORoles extends TDLAxiomImpl implements TDLAxiom, TDLNAryExpression<TDLObjectRoleExpression> {
	private final TDLNAryExpressionImpl<TDLObjectRoleExpression> delegate;

	//for OR1 = ... = ORn
	public TDLAxiomEquivalentORoles(final List<TDLExpression> v) {
		delegate = new TDLNAryExpressionImpl<TDLObjectRoleExpression>();
		delegate.add(v);
	}
	...
	public TDLObjectRoleExpression transform(TDLExpression arg) {
	...
	public List<TDLObjectRoleExpression> getArguments() {
