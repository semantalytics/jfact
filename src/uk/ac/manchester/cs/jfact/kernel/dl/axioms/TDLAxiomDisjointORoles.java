...
public class TDLAxiomDisjointORoles extends TDLAxiomImpl implements TDLAxiom, TDLNAryExpression<TDLObjectRoleExpression> {
	private final TDLNAryExpressionImpl<TDLObjectRoleExpression> delegate;

	//for OR1 != ... != ORn
	public TDLAxiomDisjointORoles(final List<TDLExpression> v) {
