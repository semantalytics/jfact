...
public class TDLAxiomDisjointUnion extends TDLAxiomImpl implements TDLAxiom, TDLNAryExpression<TDLConceptExpression> {
	private final TDLConceptExpression C;
	private final TDLNAryExpressionImpl<TDLConceptExpression> delegate;

	public TDLAxiomDisjointUnion(TDLConceptExpression c, Collection<TDLExpression> v) {
