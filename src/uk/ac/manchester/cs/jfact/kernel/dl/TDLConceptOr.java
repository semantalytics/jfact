...
public class TDLConceptOr extends TDLNAryExpressionImpl<TDLConceptExpression> implements TDLNAryExpression<TDLConceptExpression>, TDLConceptExpression {
	/** create OR of expressions from the given array */
	public TDLConceptOr(final List<TDLExpression> v) {
		add(v);
	}
