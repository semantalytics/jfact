...
public class TDLConceptDataMaxCardinality implements TDLConceptDataCardinalityExpression, TDataRoleArg {
	...
	public TDLConceptDataMaxCardinality(int n, final TDLDataRoleExpression R, final TDLDataExpression E) {
		DR = R;
