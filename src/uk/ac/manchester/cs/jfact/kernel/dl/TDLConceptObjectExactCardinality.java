...
import uk.ac.manchester.cs.jfact.kernel.dl.interfaces.TDLConceptObjectCardinalityExpression;
import uk.ac.manchester.cs.jfact.kernel.dl.interfaces.TDLObjectRoleExpression;
import uk.ac.manchester.cs.jfact.kernel.dl.interfaces.TNumberArg;
import uk.ac.manchester.cs.jfact.visitors.DLExpressionVisitor;
import uk.ac.manchester.cs.jfact.visitors.DLExpressionVisitorEx;

public class TDLConceptObjectExactCardinality implements TDLConceptObjectCardinalityExpression, TNumberArg {
	private final TConceptArg delegate;
	...
	public TDLConceptObjectExactCardinality(int n, final TDLObjectRoleExpression R, final TDLConceptExpression C) {
		N = n;
