...
public class TDLObjectRoleChain extends TDLNAryExpressionImpl<TDLObjectRoleExpression> implements TDLNAryExpression<TDLObjectRoleExpression>, TDLObjectRoleComplexExpression {
	/** create role chain from given array */
	public TDLObjectRoleChain(final List<TDLExpression> v) {
		add(v);
	}
