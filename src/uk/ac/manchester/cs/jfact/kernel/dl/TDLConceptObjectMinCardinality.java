...
public class TDLConceptObjectMinCardinality implements TDLConceptObjectCardinalityExpression, TNumberArg {
	...
	public TDLConceptObjectMinCardinality(int n, final TDLObjectRoleExpression R, final TDLConceptExpression C) {
		N = n;
