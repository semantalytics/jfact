...
public class TDLConceptAnd extends TDLNAryExpressionImpl<TDLConceptExpression> implements TDLNAryExpression<TDLConceptExpression>, TDLConceptExpression {
	/** create AND of expressions from the given array */
	public TDLConceptAnd(final List<TDLExpression> v) {
		add(v);
	}
