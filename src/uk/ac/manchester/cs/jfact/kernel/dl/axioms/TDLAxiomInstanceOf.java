...
public class TDLAxiomInstanceOf extends TDLAxiomIndividual {
	private final TDLConceptExpression C;

	public TDLAxiomInstanceOf(final TDLIndividualExpression i, final TDLConceptExpression c) {
		super(i);
		C = c;
	}
	...
	/** access */
	public final TDLConceptExpression getC() {
		return C;
	}
}
