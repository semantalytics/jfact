...
public class TDLConceptDataExactCardinality implements TDLConceptDataCardinalityExpression, TDataRoleArg {
	...
	public TDLConceptDataExactCardinality(int n, final TDLDataRoleExpression R, final TDLDataExpression E) {
		DR = R;
		expression = E;
		delegate = n;
	}
