...
public final class AxiomEquivalentORoles extends AxiomImpl implements Axiom, NAryExpression<ObjectRoleExpression> {
	private final NAryExpressionImpl<ObjectRoleExpression> delegate;

	public AxiomEquivalentORoles(final List<Expression> v) {
