...
public class TDLDataOneOf extends TDLNAryExpressionImpl<TDLDataValue> implements TDLNAryExpression<TDLDataValue>, TDLDataExpression {
	/** create one-of from individuals in the given array */
	public TDLDataOneOf(final List<TDLExpression> v) {
		add(v);
	}
