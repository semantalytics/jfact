...
public class TDLConceptObjectForall extends TConceptArgImpl implements TDLConceptObjectRCExpression {
	private final TObjectRoleArgImpl delegate;

	public TDLConceptObjectForall(final TDLObjectRoleExpression R, final TDLConceptExpression C) {
		super(C);
