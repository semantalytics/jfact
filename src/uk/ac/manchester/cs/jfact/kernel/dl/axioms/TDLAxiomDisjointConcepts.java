...
public class TDLAxiomDisjointConcepts extends TDLAxiomImpl implements TDLAxiom, TDLNAryExpression<TDLConceptExpression> {
	private final TDLNAryExpressionImpl<TDLConceptExpression> delegate;

	//for C1 != ... != Cn
	public TDLAxiomDisjointConcepts(final List<TDLExpression> v) {
