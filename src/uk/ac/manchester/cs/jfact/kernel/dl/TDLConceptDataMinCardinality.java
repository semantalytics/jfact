...
public class TDLConceptDataMinCardinality implements TDLConceptDataCardinalityExpression, TDataRoleArg {
	private final int delegate;
	private final TDLDataExpression delegateExpression;
	...
	public TDLConceptDataMinCardinality(int n, final TDLDataRoleExpression R, final TDLDataExpression E) {
		DR = R;
