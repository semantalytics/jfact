...
public class TDLDataNot implements TDLDataExpression, TDataExpressionArg<TDLDataExpression> {
	public TDLDataNot(final TDLDataExpression E) {
		Expr = E;
	}

	/** data expression argument */
	protected final TDLDataExpression Expr;
