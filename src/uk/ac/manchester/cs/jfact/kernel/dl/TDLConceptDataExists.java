...
public class TDLConceptDataExists implements TDLConceptDataRVExpression, TDataRoleArg {
	...
	public TDLConceptDataExists(final TDLDataRoleExpression R, final TDLDataExpression E) {
		DR = R;
		delegate = E;
	}
