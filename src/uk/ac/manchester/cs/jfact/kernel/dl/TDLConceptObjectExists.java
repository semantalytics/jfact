...
public class TDLConceptObjectExists extends TConceptArgImpl implements TDLConceptObjectRCExpression {
	private final TObjectRoleArgImpl delegate;

	public TDLConceptObjectExists(final TDLObjectRoleExpression R, final TDLConceptExpression C) {
		super(C);
