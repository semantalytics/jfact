...
public class TDLAxiomDisjointDRoles extends TDLAxiomImpl implements TDLAxiom, TDLNAryExpression<TDLDataRoleExpression> {
	private final TDLNAryExpressionImpl<TDLDataRoleExpression> delegate;

	//for DR1 != ... != DRn
	public TDLAxiomDisjointDRoles(final List<TDLExpression> v) {
