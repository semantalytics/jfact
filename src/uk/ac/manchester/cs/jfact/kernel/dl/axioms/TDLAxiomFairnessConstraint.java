...
public class TDLAxiomFairnessConstraint extends TDLAxiomImpl implements TDLAxiom, TDLNAryExpression<TDLConceptExpression> {
	private final TDLNAryExpressionImpl<TDLConceptExpression> delegate;

	//for Fair(C1), ... Fair(Cn)raints
	public TDLAxiomFairnessConstraint(final List<TDLExpression> v) {
