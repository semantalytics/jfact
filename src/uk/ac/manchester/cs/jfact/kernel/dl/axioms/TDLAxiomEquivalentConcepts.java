...
public class TDLAxiomEquivalentConcepts extends TDLAxiomImpl implements TDLAxiom, TDLNAryExpression<TDLConceptExpression> {
	private final TDLNAryExpressionImpl<TDLConceptExpression> delegate;

	// for C1 = ... = Cn
	public TDLAxiomEquivalentConcepts(final List<TDLExpression> v) {
