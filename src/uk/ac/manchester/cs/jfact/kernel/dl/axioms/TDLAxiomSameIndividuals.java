...
public class TDLAxiomSameIndividuals extends TDLAxiomImpl implements TDLAxiom, TDLNAryExpression<TDLIndividualExpression> {
	private final TDLNAryExpressionImpl<TDLIndividualExpression> delegate;

	//for i1 = ... = in
	public TDLAxiomSameIndividuals(final List<TDLExpression> v) {
