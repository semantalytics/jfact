...
public class TDLAxiomValueOf extends TDLAxiomIndividual {
	private final TDLDataRoleExpression A;
	private final TDLDataValue V;

	public TDLAxiomValueOf(final TDLIndividualExpression i, final TDLDataRoleExpression a, final TDLDataValue v) {
		super(i);
		A = a;
		V = v;
	}
