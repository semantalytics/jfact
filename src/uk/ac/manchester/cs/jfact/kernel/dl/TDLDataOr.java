...
public class TDLDataOr extends TDLNAryExpressionImpl<TDLDataExpression> implements TDLNAryExpression<TDLDataExpression>, TDLDataExpression {
	/** create OR of expressions from the given array */
	public TDLDataOr(final List<TDLExpression> v) {
		add(v);
	}
