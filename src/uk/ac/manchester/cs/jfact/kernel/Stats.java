...
public final class Stats {
	...
	final AccumulatedStatistic nSingletonCalls = AccumulatedStatistic.build(root);
	...
	final AccumulatedStatistic nAutoEmptyLookups = AccumulatedStatistic.build(root);
	final AccumulatedStatistic nAutoTransLookups = AccumulatedStatistic.build(root);
	...
	final AccumulatedStatistic nStateRestores = AccumulatedStatistic.build(root);
	...
	final AccumulatedStatistic nFairnessViolations = AccumulatedStatistic.build(root);
	// reasoning cache
	final AccumulatedStatistic nCacheTry = AccumulatedStatistic.build(root);
	final AccumulatedStatistic nCacheFailedNoCache = AccumulatedStatistic.build(root);
	final AccumulatedStatistic nCacheFailedShallow = AccumulatedStatistic.build(root);
