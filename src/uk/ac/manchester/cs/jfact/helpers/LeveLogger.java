...
public final class LeveLogger {
	...
	public static final LogAdapter LL = IfDefs._USE_LOGGING ? new LogAdapterStream()
			: new LogAdapterImpl();
	public static final LogAdapter LL_ABSORPTION = IfDefs.RKG_DEBUG_ABSORPTION ? new LogAdapterStream()
			: new LogAdapterImpl();
