...
public class ELFReasoner {
	...
	TELFConcept getC(ConceptExpression p) {
	...
	public ELFReasoner(Ontology ont) {
		nC2C = 0;
		nA2C = 0;
		nC2E = 0;
		nE2C = 0;
	...
	void processCI(AxiomConceptInclusion axiom) {
		assert axiom != null;
	...
	void processDeclaration(AxiomDeclaration axiom) {
		assert axiom != null;
